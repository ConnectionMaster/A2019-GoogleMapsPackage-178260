...
public final class StartSessionCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    if(convertedParameters.get("APIKeyInput") == null) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.notEmpty","APIKeyInput"));
    }

    command.setSessions(sessionMap);
    command.setGlobalSessionContext(globalSessionContext);
    try {
      command.action((String)convertedParameters.get("sessionName"),(SecureString)convertedParameters.get("APIKeyInput"));Optional<Value> result = Optional.empty();
