...
public final class SearchPlacesCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SearchPlacesCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SearchPlaces command = new SearchPlaces();
    ...
    if(parameters.containsKey("search") && parameters.get("search") != null && parameters.get("search").get() != null) {
      ...
      if(!(convertedParameters.get("search") instanceof String)) {
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("search")));
